 ...
 */
final class Version20220126153647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, poster_path VARCHAR(255) DEFAULT NULL, adult TINYINT(1) DEFAULT NULL, release_date DATE DEFAULT NULL, overview LONGTEXT DEFAULT NULL, original_title VARCHAR(255) DEFAULT NULL, original_language VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
